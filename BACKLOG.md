...
- Sıradaki tek adım: zaman ve PML yakınsaması geçti. Mesh-rung-1 (10→12 step/λ, task `fdve-3c712882-71d2-42b0-bf94-c09daf525f2c`, tahmini `10.717 FC`) Hasan onayıyla `2026-09-11`'de başlatıldı, şu an `queued`. Tamamlanınca `time-rung-3` (10 step/λ) ile through/drop flux ve decay tutarlılığını karşılaştır; geçerse başarı kapısı 3 (mesh+zaman+PML) tam kapanır ve Kerr+TPA aşaması açılabilir. Geçmezse 14/16 step/λ (tahmini `17-25 FC`) ayrı onay gerektirir.
